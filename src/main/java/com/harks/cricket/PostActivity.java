...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adsManager.createUnifiedAds(R.string.ads_native_ads, new AdsunifiedListening() {
            ...
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                ...
                TemplateView ads=findViewById(R.id.my_templatePost);
        ...
        adsManager.createUnifiedAds(R.string.ads_native_ads, new AdsunifiedListening() {
            ...
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                ...
                TemplateView ads=findViewById(R.id.my_templatePost2);
                NativeTemplateStyle style=new NativeTemplateStyle.Builder().withMainBackgroundColor(new ColorDrawable(Color.parseColor("#ffffff"))).build();
        ...
        adsManager.createUnifiedAds(R.string.ads_native_ads, new AdsunifiedListening() {
            ...
            public void onUnifiedNativeAdLoaded(UnifiedNativeAd unifiedNativeAd) {
                ...
                TemplateView ads=findViewById(R.id.my_templatePost3);
                NativeTemplateStyle style=new NativeTemplateStyle.Builder().withMainBackgroundColor(new ColorDrawable(Color.parseColor("#ffffff"))).build();
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PostActivity.this , firstpageActivity2.class));
                finish();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK){
            ...
            startActivity(new Intent(PostActivity.this , MainActivityCricKo.class));
            finish();
        }
    }
}